  ...
  return (
    <div className="bg-gray-50">
      <div className="mx-auto px-4 mt-5 textart">
        ...
        <div className="flex justify-between gap-10 mt-20 md:mt-5 flex-col md:flex-row md:flex-wrap lg:flex-row">
          {articleData.map((data) => {
            return (
              <div className="w-8/9 md:w-2/9 shadow-sm rounded-sm ">
