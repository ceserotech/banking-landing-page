  ...
  return (
    <div className="bg-gray-50">
      <div className="mx-auto px-10 lg:px-25 mt-5 py-30">
        ...
        <div className="flex justify-between px-0 gap-10 mt-15 md:mt-5 flex-col md:flex-row md:flex-wrap lg:flex-row">
          {articleData.map((data) => {
            return (
              <div className="w-10/10 md:w-2/9 shadow-sm rounded-sm bg-gray-100" id={data.id}>
                ...
                <h2 className="text-lg my-1 p-2 myp">{data.title}</h2>
