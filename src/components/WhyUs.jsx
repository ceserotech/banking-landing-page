  ...
  return (
    <div className="w-full bg-gray-300 -z-1000 mt-3 lg:-mt-30 whyus">
      <div className="mx-auto px-10 lg:px-25 mt-5 ">
        ...
        <div className="flex  items-center md:justify-between md:items-start px-0 gap-10 mt-20 md:mt-5 flex-col md:flex-row md:flex-wrap lg:flex-row md:text-left">
          <div className="w-8/10 md:w-2/11 flex flex-col justify-center items-center md:flex-none lg:items-start py-5">
          ...
          <div className="w-8/10 md:w-2/11 px-y flex flex-col justify-center items-center md:flex-none lg:items-start py-5">
